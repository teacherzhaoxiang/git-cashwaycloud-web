...
import {ProAccountSettingsDefaultIndexHtmlComponent} from "./account/settings/default-index-html/default-index-html.component";
    ...
    children: [
      ...
      },
      {
        ...
        children: [
          ...
          // },
          {
              path: 'buttons-contain-icon',
              component: ProAccountSettingsButtonsContainIconComponent,
              data: { titleI18n: 'pro-account-settings' },
          },
            {
                path: 'default-role',
                component: ProAccountSettingsDefaultRoleComponent,
                data: { titleI18n: 'pro-account-settings' },
            },
            {
                path: 'default-index-html',
                component: ProAccountSettingsDefaultIndexHtmlComponent,
                data: { titleI18n: 'pro-account-settings' },
            },
