    ...
    template: `
        <nz-card>
            <div style="display:flex;" class="modal">
                <iframe style="width:100%;" frameborder="false" class="preview"></iframe>
            </div>
        </nz-card>
    `, styles: [
        `
...
export class PreviewVideoWidget extends ControlWidget implements OnInit, OnDestroy {

    static readonly KEY = 'previewVideo';
