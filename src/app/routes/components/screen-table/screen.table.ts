                ...
                <div nz-row class="modal-content">
                    <nz-col nzSpan="24">
                        ...
                        >
                            ...
                            >
                                <nz-table #t [nzData]="convertItems(items)" nzTotal="100" nzPageIndex="2" nzPageSize="10" nzSize="small">
                                    <tbody>
...
export class ScreenCheckTransferCustomItemComponent implements OnInit {
    @Input()
        dataType:any = "string";
    @Input()
        resultParam:any = "id";
    ...
    searchSchema: any = {
        properties: {
            screenName: {type: "string",title: "屏幕名称",ui:{
                    spanLabelFixed:80,
                    grid:{span:8}
                }
            },
            ...
            type: {type: "string",title: "类型",ui: {
                    ...
                    spanLabelFixed:80,
                    grid:{span:8},
                    asyncData:()=>this.http.get(environment.gateway_server_url+"/engine/rest/common/monitor_terminal_type/selects",{mate:JSON.stringify(this.mate),params:this.param})
                }},
    ...
    change(ret: {}): void {
        ...
        console.log('nzChange', this.selectedList);
