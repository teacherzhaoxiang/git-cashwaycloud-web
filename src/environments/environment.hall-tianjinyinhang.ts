...
//     gateway_server_url: 'http://192.168.2.235:8090',
    ...
    logoFullImage:'./assets/xingye-bank/xingye-bank.png',//厅堂管理logo
    ...
    gif:'/assets/message-publish-xingyebank.gif',//吉林登录gif动图
...
//   //  sessionLogin: true, //开启sessionStorage保存用户登录信息
    ...
    programId:'hall',
    sessionLogin: true, //开启sessionStorage保存用户登录信息
    // allOptional: false, //true:机构树全部可选，false：netCode存在的时候才能选中
