...
(function(c, f, h, k) {
	...
	g.prototype = {
		...
		createHtml: function() {
			...
			a = [
				'\x3cdiv style\x3d"position: relative;z-index: 9999;"  id\x3d"paigusu-screen"\x3e',
				'\x3cdiv style\x3d"width: ' +  "100%;height: " + a.height +
				"px;background: #fff;position: absolute;top: " + 0 + "px;left: " + a.positionLeft +
				...
				'\x3cdiv style\x3d"width:16px;height:16px;border-radius: 8px;background: rgba(' + a.color.r + "," + a.color.g +
				"," + a.color.b + ');" id\x3d"final-color"\x3e\x3c/div\x3e',
				...
				'\x3cdiv style\x3d"width: 100%;height: 10px;background:linear-gradient(to right, rgba(' + b + ", 0) 0%, rgba(" +
				b + ', 1) 100%);position: relative;" id\x3d"paigusu-alpha-block"\x3e',
				...
				'\x3cdiv style\x3d"height: 70px;width:100%;padding: 5px 0;box-sizing: border-box;"\x3e', d,
