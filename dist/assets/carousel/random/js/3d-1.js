...
(function ($) {
    ...
    Carousel.prototype = {
        //设置上一张和下一张大小
        setDirect: function () {
            var prev = $("<div sytle='display:none'></div>").addClass("content-btn prev-btn").append($("<img sytle='display:none' />").attr("src", "img/left.png"));
            this.con.prepend(prev);
            var next = $("<div sytle='display:none'></div>").addClass("content-btn next-btn").append($("<img sytle='display:none'/>").attr("src", "img/right.png"));
        ...
        setPostOther: function () {
            ...
            var lw = rightItem.last().width(), lh = rightItem.last().height();
